...
Cada usuário começa com um saldo fictício de R$ 1.000,00 e pode escolher um time e informar o valor que deseja apostar. Quando uma aposta é realizada, o servidor valida as informações, desconta o valor do saldo e compartilha a aposta em tempo real com todos os usuários conectados.
